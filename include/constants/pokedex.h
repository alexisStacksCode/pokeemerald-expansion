...
enum NationalDexOrder
{
    ...
    // Custom
    NATIONAL_DEX_CLOUD_STRIFE,
    NATIONAL_DEX_DAPHNE_BLAKE,
    NATIONAL_DEX_DUKE_NUKEM,
};

#define KANTO_DEX_COUNT     NATIONAL_DEX_MEW
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#define NATIONAL_DEX_COUNT (NATIONAL_DEX_DUKE_NUKEM + 1)
...
{
    HOENN_DEX_NONE,
    HOENN_DEX_CLOUD_STRIFE,
    HOENN_DEX_DAPHNE_BLAKE,
    HOENN_DEX_DUKE_NUKEM,
};

#define HOENN_DEX_COUNT (HOENN_DEX_DUKE_NUKEM + 1)
