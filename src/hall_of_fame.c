...
static void Task_Hof_DisplayPlayer(u8 taskId)
{
    ...
    ShowBg(1);
    ShowBg(3);
    gTasks[taskId].tPlayerSpriteID = CreateTrainerPicSprite(GetPlayerFrontSpriteId(), TRUE, 120, 72, 6, TAG_NONE);
...
static void SpriteCB_GetOnScreenAndAnimate(struct Sprite *sprite)
{
    ...
    else
    {
        ...
        if (species == SPECIES_EGG)
            DoMonCry(sprite, species, TRUE, 3);
        else
            DoMonCry(sprite, species, FALSE, 3);
    }
}
