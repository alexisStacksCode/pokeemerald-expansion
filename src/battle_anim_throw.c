...
static void AnimTask_BlueGradientUpHealthboxOnLevelUp_Step(u8);
...
void AnimTask_BlueGradientUpHealthboxOnLevelUp(u8 taskId)
{
    ...
    gTasks[taskId].func = AnimTask_BlueGradientUpHealthboxOnLevelUp_Step;
}

static void AnimTask_BlueGradientUpHealthboxOnLevelUp_Step(u8 taskId)
{
    ...
    case 2:
        if (gTasks[taskId].data[11]++ > 1)
        {
            ...
            if (gTasks[taskId].data[12] == 0)
            {
                ...
                struct Sprite *healthboxSprite = &gSprites[gHealthboxSpriteIds[gBattleAnimAttacker]];
