...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_PLAYER_MALE, gTrainerFrontPic_Brendan, gTrainerPalette_Brendan),
    TRAINER_SPRITE(TRAINER_PIC_PLAYER_FEMALE, gTrainerFrontPic_May, gTrainerPalette_May),
