...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    */
    ...
    [SPECIES_DAPHNE_BLAKE] =
    {
        ...
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Daphne B."),
        .cryId = CRY_GLACEON,
        .natDexNum = NATIONAL_DEX_NONE,
        .categoryName = _("Danger-Prone"),
        .height = 0,
        .weight = 0,
        .description = COMPOUND_STRING(
            "When threatened by bigger prey, it\n"
            "enters a panic state in an attempt\n"
            "to escape or fight off its predator."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
