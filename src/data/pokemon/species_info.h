...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    */
    ...
    [SPECIES_DAPHNE_BLAKE] = // Scooby-Doo
    {
        ...
        .cryId = CRY_FLOETTE,
        .faintCryId = CRY_FROSLASS,
        .dexNum = DEX_DAPHNE_BLAKE,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_DaphneBlake,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .backPic = gMonBackPic_DaphneBlake,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .palette = gMonPalette_DaphneBlake,
        .shinyPalette = gMonShinyPalette_DaphneBlake,
        .iconSprite = gMonIcon_DaphneBlake,
        .iconPalIndex = 6,
        FOOTPRINT(QuestionMark)
    ...
    [SPECIES_VELMA_DINKLY] = // Scooby-Doo
    {
        .baseHP        = 90,
        .baseAttack    = 105,
        .baseDefense   = 85,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Velma Dinkly"),
        .cryId = CRY_AIPOM,
        .faintCryId = CRY_ABRA,
        .dexNum = DEX_VELMA_DINKLY,
        .categoryName = _("Big Brain"),
        .height = 0,
        .weight = 0,
        .description = COMPOUND_STRING(
            "This is a newly discovered Pokémon.\n"
        ...
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sVelmaDinklyLevelUpLearnset,
        .teachableLearnset = sVelmaDinklyTeachableLearnset,
        SHADOW(0, 14, SHADOW_SIZE_S)
    },
