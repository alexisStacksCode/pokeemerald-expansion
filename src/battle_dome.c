...
static void CalcDomeMonStats(const struct TrainerMon *fmon, int level, u8 ivs, int *stats)
{
    ...
    {
        int n = 2 * GetSpeciesBaseStat(fmon->species, STAT_HP);
...
static void DisplayTrainerInfoOnCard(u8 flags, u8 trainerTourneyId)
{
    ...
    if (trainerId == TRAINER_PLAYER)
        sInfoCard->spriteIds[arrId] = CreateTrainerPicSprite(GetPlayerFrontSpriteId(), TRUE, x + 48, y + 64, palSlot + 12, TAG_NONE);
...
static void DisplayMatchInfoOnCard(u8 flags, u8 matchNo)
{
    ...
    if (trainerIds[0] == TRAINER_PLAYER)
        sInfoCard->spriteIds[arrId] = CreateTrainerPicSprite(GetPlayerFrontSpriteId(), TRUE, x + 48, y + 88, palSlot + 12, TAG_NONE);
    ...
    if (trainerIds[1] == TRAINER_PLAYER)
        sInfoCard->spriteIds[1 + arrId] = CreateTrainerPicSprite(GetPlayerFrontSpriteId(), TRUE, x + 192, y + 88, palSlot + 13, TAG_NONE);
