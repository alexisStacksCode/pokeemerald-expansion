 ...
 *  - Otherwise, advance to Task_DisplayMainMenuInvalidActionError.
 *
...
static const u8 gText_No1MSubCircuit[] = _("Got SAVE_STATUS_NO_FLASH!");
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    brendanSpriteId = CreateTrainerSprite(TRAINER_PIC_PLAYER_MALE, 120, 60, 0, NULL);
    gSprites[brendanSpriteId].callback = SpriteCB_Null;
    gSprites[brendanSpriteId].invisible = TRUE;
    gSprites[brendanSpriteId].oam.priority = 0;
    gTasks[taskId].tBrendanSpriteId = brendanSpriteId;
    maySpriteId = CreateTrainerSprite(TRAINER_PIC_PLAYER_FEMALE, 120, 60, 0, NULL);
...
static void MainMenu_FormatSavegamePokedex(void)
{
    ...
    {
        dexCount = GetDexCount(FLAG_GET_CAUGHT);
